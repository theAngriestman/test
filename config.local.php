...
require_once('xhprof_init.php');
ini_set('display_errors', 1); $config['demo_username'] = 'admin@demo.com'; $config['demo_password'] = 'admin';
...
$config['db_name'] = 'lev_4172ultru_prod';
$config['db_user'] = 'admin';
$config['db_password'] = '5wzY5wdRtrFHV5YZbVFBYjmM';

$config['database_backend'] = 'mysqli';

// Database tables prefix
$config['table_prefix'] = 'lev_';
...
$config['http_host'] = 'lev.test.abt.team';
$config['http_path'] = '/4172ultru_prod';

// Host and directory where software is installed on secure server
$config['https_host'] = 'lev.test.abt.team';
$config['https_path'] = '/4172ultru_prod';
...
$config['tweaks'] = array (
    ...
    'validate_menu' => false,// => true, // Disable option to add any new element to top and central admin panel menu and to Add-ons top menu element.
