    ...
    <div id="ab_am_addons">
        ...
        {if !empty($available_products.addons)}
            ...
            <div>
                ...
                <div id="ab__am_available_addons" class="{if $state == 'open'}in {/if}collapse" style="/*overflow: hidden;*/">
        ...
        {if !empty($available_products.sets)}
            ...
            <div>
                ...
                <div id="ab__am_available_sets" class="{if $state == 'open'}in {/if}collapse" style="/*overflow: hidden;*/">
