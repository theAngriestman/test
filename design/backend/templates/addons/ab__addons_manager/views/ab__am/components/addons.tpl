...
<tbody>
<tr>
    <td class="pd-nr"><span class="iteration">{$iteration}.&nbsp;</span><span class="ab_logo {$cs_addons[$a.key].status} cm-tooltip hand" title="{__("ab__am.addon.status.{$cs_addons[$a.key].status|default:'n'}")}">&nbsp;</span></td>
